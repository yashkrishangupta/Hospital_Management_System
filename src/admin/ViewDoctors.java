...
public class ViewDoctors extends JFrame {
    ...
    private void buildUI() {
        ...
        add(header);
        header.add(UITheme.createLabel("Registered Doctors",
                UITheme.FONT_HEADER, UITheme.TEXT_PRIMARY, 26, 14, 500, 26));
        header.add(UITheme.createLabel("All doctors available for appointment booking",
        ...
        String[] cols = {"ID", "Doctor Name", "Specialization"};
        ...
        table.getColumnModel().getColumn(2).setPreferredWidth(540);
        ...
        JButton deleteBtn = UITheme.createDangerButton("Delete Doctor", 200, 10, 180, 38);
    ...
    private void deleteSelected() {
        ...
        if (row < 0) {
            UITheme.showWarning(this, "Please select a doctor row first.");
            return;
        }
